...
source("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/util/intersect_functions.R")
source("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/util/plotting_functions.R")
source("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/util/_setup.R")
...
promoter_peak_occurence_matrix <- read.table("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/12_peak_features/lncrna_mrna_promoter_peak_occurence_matrix.tsv")
...
pdf("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/15_clustering/figures/dbp_hclust_dendro.pdf", height = 12, width = 70)
plot(bin_hier)
dev.off()
...
ggsave("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/15_clustering/figures/ggdendro_plot.pdf", height = 50, width = 12, limitsize = F)
...
lncrna_promoters <- rtracklayer::import("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/11_consensus_peaks/gene_annotation_files/lncrna_promoters.gtf")
...
mrna_promoters <- rtracklayer::import("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/11_consensus_peaks/gene_annotation_files/mrna_promoters.gtf")
...
ggsave("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/15_clustering/figures/lncrna_hclust_binary_dist.pdf", height = 44, width = 6)
...
# saving
ggsave("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/15_clustering/figures/mrna_hclust_binary_dist.pdf", height = 44, width = 6)
...
ggsave("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/15_clustering/figures/high_binder_heatmap.pdf", height = 44, width = 6 )
...
num_peaks_df <- read_csv("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/12_peak_features/num_peaks_df.csv")
...
# saving this
ggsave("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/15_clustering/figures/ZFN_high_binder_heatmap.pdf", height = 44, width = 6 )
...
pdf("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/15_clustering/figures/zfn_clustering.pdf")
zf_hclust <- hclust(dist(zf_matrix, method = "binary"))
plot(zf_hclust)
dev.off()
...
write.csv(promoter_dbps, "/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/12_peak_features/promoter_dbps.csv")
...
promoter_dbps <- read.csv("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/12_peak_features/promoter_dbps.csv")
