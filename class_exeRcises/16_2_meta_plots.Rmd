...
ggplot(metaplot_df, aes(x = x, y = dens)) + 
  ...
  scale_x_continuous(breaks = c(-1000, 0, 1000),
                     ...
                     name = "") + 
  ylab("Peak frequency")
ggsave("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/16_meta_plots/figures/POLR2A_promoter_metaplot.pdf")
#CHANGED
```
...
lncrna_promoters <- promoters(lncrna_genes, upstream = 1e3, downstream = 1e3)
#CHANGED
...
mrna_promoters <- promoters(mrna_genes, upstream = 1e3, downstream = 1e3)
#CHANGED
...
write_rds(metaplot_df, "/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/16_2_meta_plots/metaplot_df_final_test.rds")
...
# read in metaplot_df
metaplot_df <- read_rds("/scratch/Shares/rinnclass/CLASS_2022/LisaH/BCHM_lisahansen/class_exeRcises/analysis/16_meta_plots/metaplot_df_final_test.rds")
